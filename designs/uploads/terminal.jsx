...
function TerminalPane({ theme, tabKey, project, tab, script, monoFont, onReattach }) {
  ...
  const [streamingText, setStreamingText] = useStateT(null);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span>reattached — pid 48192 · uptime 2h 14m</span>
      </div>
